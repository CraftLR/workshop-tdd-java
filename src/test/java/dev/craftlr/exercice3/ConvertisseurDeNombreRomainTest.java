...
public class ConvertisseurDeNombreRomainTest {
    ...
    public void leChiffreRomainXIDevraitDonner11() {
        int nombre = convertisseurDeNombreRomain.enNombreArabe("XI");
        assertEquals(11, nombre);
    }
    ...
    public void leChiffreRomainCDevraitDonner100() {
        int nombre = convertisseurDeNombreRomain.enNombreArabe("C");
        assertEquals(100, nombre);
    }
    ...
    public void leChiffreRomainDDevraitDonner500() {
        int nombre = convertisseurDeNombreRomain.enNombreArabe("D");
        assertEquals(500, nombre);
    }

    @Disabled
    @Test
    public void leChiffreRomainMDevraitDonner1000() {
        int nombre = convertisseurDeNombreRomain.enNombreArabe("M");
        assertEquals(1000, nombre);
    }
